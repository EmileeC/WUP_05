...
A new  preventative aides drug (triumphal) is under test in clinical trials. Consider only the females, does this drug seem effective?  Hint - use dplyr to obtain that sub population with the filter command.
...
We need to get subset of the data that consists of just female. 
```{r}
...
In the data above, you can observe that 58% of women Who took triumphal resulted in having aids.Whereas 41% of people who took the placebo got aids. More people who took triumphal got aids vs women taking the placebo.  
...
In this set of data, we took the number of females who tried triumphal to help prevent aids. Some women were given the drug and some were given a placebo. 11,768 women were analyzed in this study and in conclusion we found out a few things. For one, the drug did not seem to work for the female population. Secondly, we saw that 210 women who had taken the drug actually wound up getting aids, v5 147 people who took the placebo who got aids. We can note that more people who received the drugs wound up getting aids. Our P value for the Fisher test was very small at 0.0001, which led us to reject the null hypothesis.  
